...
<?= $this->section('page_title') ?>Registrar Etiqueta<?= $this->endSection() ?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Registrar Etiqueta</h1>
                <p>Esta sección le permite registrar una etiqueta en el sistema</p>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Registrar etiqueta</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Registrar Etiqueta</h3>
                    </div>
                    <form role="form" id="formCreateTag">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="name">Nombre</label>
                                <input type="text" name="name" id="name" class="form-control" placeholder="Nombre de la etiqueta">
                            </div>
                            <div class="form-group">
...
<script src="<?= base_url('public/js/admin/tags/create.js') ?>"></script>
<?= $this->endSection() ?>
